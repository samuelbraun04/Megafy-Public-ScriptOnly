# THIS SCRIPT IS FUNCTIONAL BUT INEFFICIENT. IT IS CONTINUALLY UPDATED (ADDED FEATURES AND BETTER OPTIMISATION).
# CURRENTLY, SCRIPT REQUIRES MANUAL PATH INPUT. THIS IS TEMPORARY.
